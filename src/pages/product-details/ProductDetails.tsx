...
// --- Local Components
import Discount from "../home/special-offers/components/Discount";
import RatingAndViews from "../home/special-offers/components/RatingAndViews";
...
const ProductDetails = () => {
  ...
  const product = specialOffers.find((offer) => offer.id === +params.id!);

  // --- Return JSX (Not Found Product)
  if (!product) {
    return (
      <h1 className="bg-red-100 text-red-500 p-5 h-100 rounded-2xl mt-10 text-5xl flex items-center justify-center font-jetbrains font-bold">
        Product Not Found
      </h1>
    );
  }
